...
<head>
  ...
  <!--User CSS-->
  <link rel="stylesheet" type="text/css" href="css/projecao.css?v=0.0.8">
  ...
  <!--User Scripts-->
  <script src="js/projecaofunctions.js?v=0.0.8"></script>
  <script src="js/projecao.js?v=0.0.8"></script>
...
<script src="js/projecaofooter.js?v=0.0.8"></script>
