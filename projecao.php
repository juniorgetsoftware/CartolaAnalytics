...
<head>
  ...
  <!--User CSS-->
  <link rel="stylesheet" type="text/css" href="css/projecao.css?v=1.0.0">
  ...
  <!--User Scripts-->
  <script src="js/projecaofunctions.js?v=1.0.0"></script>
  <script src="js/projecao.js?v=1.0.0"></script>
...
<script src="js/projecaofooter.js?v=1.0.0"></script>
