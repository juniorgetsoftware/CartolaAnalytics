...
<head>
  ...
  <!--Bracket CSS-->
  <link rel="stylesheet" type="text/css" href="css/jquery.bracket.min.css?v=1.0.1">
  
  <!--User CSS-->
  <link rel="stylesheet" type="text/css" href="css/matamataHostilidade.css?v=1.0.1">
  ...
  <!--Bracket Script-->
  <script src="js/jquery.bracket.min.js?v=1.0.1"></script>
  
  <!--User Scripts-->
  <script src="js/matamataHostilidadefunctions.js?v=1.0.1"></script>
  <script src="js/matamataHostilidade.js?v=1.0.1"></script>
...
<div class="container-fluid">    
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <br>
            <h3 class="h3Mercado">Liga Hostilidade Brasil - Mata-mata 03</h3>
...
<script src="js/matamataHostilidadefooter.js?v=1.0.1"></script>
