...
<head>
  ...
  <!--User CSS-->
  <link rel="stylesheet" type="text/css" href="css/index.css?v=0.0.7">
  ...
  <!--User Scripts-->
  <script src="js/indexfunctions.js?v=0.0.7"></script>
  <script src="js/index.js?v=0.0.7"></script>
...
<script src="js/indexfooter.js?v=0.0.7"></script>
